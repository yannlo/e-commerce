...
use App\Models\Orders\Classes\Exceptions\SaveCarts\CartInMySQLException;
...
class CartInMySQL
{
    ...
    public function get(Customer $customer): ?Cart
    {
        ...
        {
            $exception= new CartInMySQLException("Recovery cart error in the database",700);
        ...
        {
            $exception= new CartInMySQLException("Never cart to this customer",500);
            throw $exception;
            return null;
        }
        ...
        {
            $exception= new CartInMySQLException("inconsistent result",800);
            throw $exception;
            return null;
        }
    ...
    public function add(Cart $cart): void
    {
        ...
        {   
            $exception= new CartInMySQLException("Recovery orderLine error in the database",700);
            $exception->setPDOMessage($e->getMessage());
            throw $exception;
            return;
        }
    ...
    public function cartExist(Customer $customer): ?bool
    {
        ...
        if($request->rowCount()>1)
        {
            $exception= new CartInMySQLException("Never orderLine to this order",800);
            throw $exception;
            return null;
        }
